...
function TendrUp() {
  ...
  return (
    ...
    <Row>
        <Col md={{ span: 2, offset: 2 }}> Update Signed Parties</Col>
    ...
    <Row >. R3</Row>
    <Row>
        <Col md={{ span: 3, offset: 3 }}>Set Float Date</Col>
        <Col>
        <Form.Control type="date" onSelect={(e) => console.log(e.target.value)}></Form.Control>
        
        </Col>
        <Col md={{ span: 1, offset: 3 }}></Col>
    </Row>

    <Row> R4</Row>
    <Row>
        <Col md={{ span: 3, offset: 3 }}>Set Close Date</Col>
        <Col>
        <Form.Control type="date" onSelect={(e) => console.log(e.target.value)}></Form.Control>
        </Col>
        <Col md={{ span: 1, offset: 3 }}></Col>
    ...
    <Row> R5</Row>
    <Row>
        <Col md={{ span: 3, offset: 3 }}>Set Bidders</Col>
    ...
    <Row> R6</Row>
    <Row>
        <Col md={{ span: 3, offset: 3 }}>Award Bidder</Col>
