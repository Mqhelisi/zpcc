...
def setup_db(app):
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql+psycopg2://postgres:12345@localhost:5432/zpcproj"
...
class Project(db.Model):
    ...
    def __init__(self, name, bus_case, background, justification, proj_goals,proj_team):
        self.name = name
