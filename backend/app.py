...
# import json
# x =  '{ "GOAL 1":"More getsi", "GOAL 2":"MORE MONEY", "GOAL 3":"Into Zeskhiwa"}'
# y = json.loads(x)
# z =  '{ "Proj Manager":"J Money", "Proj Chairman":"E Mercedes", "Proj Board 1":"J Moyo"}'
# a = json.loads(z)
# word = Project('Munyati Solar Project',
#              'we need more electricity for people',
#              'peope keep buying new phones and electrically consuming things', 
#                 'we will get more money in the gurb yeyi', y,a)
